            ...
            this.state.facilityList.map((item) => {
                ...
                return (
                    ...
                    <View style={{ marginTop: '0%', flexDirection: 'row' }}>
                        ...
                        <TouchableOpacity style={{ backgroundColor: item.color, height: 20, borderRadius: 15, marginLeft: '6%', width: '20%', marginTop: 35, textAlign: 'center', textAlignVertical: 'center', paddingTop: 0, }}>
